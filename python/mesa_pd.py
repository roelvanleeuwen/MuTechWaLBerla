...
if __name__ == '__main__':
    ...
    ch.add_property("id1", "walberla::id_t", defValue="walberla::id_t(-1)")
    ch.add_property("id2", "walberla::id_t", defValue="walberla::id_t(-1)")
    ch.add_property("initialPenetrationDepth", "real_t", defValue="real_t(0)")
    #ch.add_property("penetrationDepth", "real_t", defValue="real_t(0)")
    ...
    ch.add_property("rupture", "real_t", defValue="real_t(0)")
