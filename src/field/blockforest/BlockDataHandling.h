...
inline GhostLayerField_T * allocate( const uint_t x, const uint_t y, const uint_t z, const uint_t gl,
                                     ...
                                     const shared_ptr< field::FieldAllocator<typename GhostLayerField_T::FlattenedField::value_type> > & alloc)
{
...
public:
   ...
   using FlattenedType_T = typename GhostLayerField_T::FlattenedField::value_type;
   ...
   DefaultBlockDataHandling( const weak_ptr< StructuredBlockStorage > & blocks,
                             ...
                             const shared_ptr< field::FieldAllocator<FlattenedType_T> > & alloc = shared_ptr< field::FieldAllocator<FlattenedType_T> >()) :
...
private:
   ...
   const shared_ptr< field::FieldAllocator<FlattenedType_T> > & alloc_;
