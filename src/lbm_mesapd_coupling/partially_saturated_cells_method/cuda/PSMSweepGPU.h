 ...
 public:
   ...
   void operator()(IBlock* block)
   {
      ...
      auto particleAndVolumeFractionField =
         block->getData< walberla::cuda::GPUField< PSMCell_T > >(particleAndVolumeFractionFieldID_);
      ...
      myKernel.addFieldIndexingParam(walberla::cuda::FieldIndexing< PSMCell_T >::xyz(*particleAndVolumeFractionField));
      myKernel();
   }
