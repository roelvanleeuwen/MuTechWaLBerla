...
namespace python_coupling {
   ...
   */
   //*******************************************************************************************************************
   class PythonCallback_pybind
   {
   public:
      PythonCallback_pybind();
      PythonCallback_pybind( const std::string & functionName );
      PythonCallback_pybind( const std::string & moduleOrFile,
                             const std::string & functionName,
                             const std::vector<std::string> & argv = std::vector<std::string>() );

            DictWrapper_pybind & data()       { return *exposedVars_; }
      const DictWrapper_pybind & data() const { return *exposedVars_; }
   ...
   protected:
      ...
      shared_ptr<DictWrapper_pybind> exposedVars_;
      shared_ptr<DictWrapper_pybind> callbackDict_;
   };
