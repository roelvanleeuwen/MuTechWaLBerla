 ...
 public:
   static shared_ptr< StructuredBlockForest >
      create(Vector3< uint_t > blocks, Vector3< uint_t > cellsPerBlock, Vector3< bool > periodic,
             py::object blockExclusionCallback, py::object workloadMemoryCallback,
             py::object refinementCallback, const real_t dx = 1.0,
...
void exportBlockForest(py::module_& m)
{
   ...
   py::class_< python_createUniformBlockGrid >(m, "createUniformBlockGrid")
      .def_static("create", &python_createUniformBlockGrid::create);
   ...
   py::class_<createStructuredBlockForest>(m, "createCustomBlockGrid")
      .def_static("create", &createStructuredBlockForest::create, py::arg("blocks"), py::arg("cellsPerBlock"),
            py::arg("periodic"), py::arg("blockExclusionCallback"),
            py::arg("workloadMemoryCallback"), py::arg("refinementCallback"),
            py::arg("dx") = 1.0, py::arg("processMemoryLimit") = std::numeric_limits< memory_t >::max(),
