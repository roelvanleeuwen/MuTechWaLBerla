...
void basic_test()
{
   ...
   WALBERLA_CHECK_IDENTICAL(cs.getImpactVelocityMagnitude(), cs.getImpactVelocityMagnitude());
   WALBERLA_CHECK_IDENTICAL(cs.getIsSticking(), cs.getIsSticking());
   WALBERLA_CHECK_IDENTICAL(cs.getTangentialSpringDisplacement(), cs.getTangentialSpringDisplacement());
