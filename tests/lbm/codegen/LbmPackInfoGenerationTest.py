...
with CodeGeneration() as ctx:
    ...
    update_rule_odd = create_lb_update_rule(collision_rule=collision_rule, optimization=optimization, streaming_pattern=streaming_pattern, timestep=Timestep.ODD)
