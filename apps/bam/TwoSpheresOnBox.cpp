...
int main( int argc, char ** argv )
{
   ...
   real_t boxEdgeLength = 2_r * sphereRadius;
   real_t boxMass = sphereDensity * boxEdgeLength * boxEdgeLength * boxEdgeLength;
   auto boxShape = ss->create<data::Box>(Vec3(boxEdgeLength));
   ss->shapes[boxShape]->updateMassAndInertia(sphereDensity);
   ...
   std::vector<walberla::id_t> sphereUids(spherePositions.size());
   ...
   // vtk
   std::string vtkOutputFolder = "vtk_out_particles_sphereAndBox";
